<?php
	...
	$query = "SELECT d.id as departmentID, d.name as departmentName, l.name as locationName FROM department d LEFT JOIN location l ON (l.id = d.locationID) ORDER BY d.name";
