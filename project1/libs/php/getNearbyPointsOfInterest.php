...
if (!$lat || !$lon) {
    ...
    $output["status"]["name"] = "Failure - Error retrieving lat or lon value from getPointsOfInterest.php";
...
$url = "https://eu1.locationiq.com/v1/nearby.php?key=" . $locationIQApiKey . "&lat=" . $lat . "&lon=" . $lon . "&radius=2000&format=json";
